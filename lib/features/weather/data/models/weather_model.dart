...
class Location {
  ...
  Location.fromJson(Map<String, dynamic> json) {
    ...
    localtime = DateTime.tryParse(json['localtime'])?.toLocal();
  ...
  Map<String, dynamic> toJson() {
    ...
    data['localtime'] = localtime?.toIso8601String();
...
class Astro {
  ...
  Astro.fromJson(Map<String, dynamic> json) {
    ...
    // moonrise = DateTime.parse(json['moonrise']).toLocal();
    // moonset = DateTime.parse(json['moonset']).toLocal();
